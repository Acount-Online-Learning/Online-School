  ...
  Widget build(BuildContext context) {
    return  Column(
      children: [
        ...
        InkWell(
          onTap: (){
            Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>HomeParent()), (route) => false);
          },
          child: ListTile(
        ...
        InkWell(
          ...
          child: ListTile(
            ...
            title: Text('Childern',style: TextStyle(color: Colors.white),),
          ),
        ),
        InkWell(
          onTap: (){
            Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>ExamsChildren()), (route) => false);
